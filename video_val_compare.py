...
# python video_val_compare.py --gt_root sav_test/Annotations_6fps --pred_root output_predictions_large
# python video_val_compare.py --gt_root sav_test/Annotations_6fps --pred_root output_predictions_tiny
# python video_val_compare.py --gt_root sav_test/Annotations_6fps --pred_root output_predictions_tiny_0
# python video_val_compare.py --gt_root sav_test/Annotations_6fps --pred_root output_predictions_test
"""
